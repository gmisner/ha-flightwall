...
class FlightwallFlightSensor(SensorEntity):
    ...
    def extra_state_attributes(self) -> dict[str, Any]:
        return {
            ...
            "show_silhouette": self._runtime.show_silhouette,
            "show_photo": self._runtime.show_photo,
            "auto_night": self._runtime.auto_night,
            "pinned": self._runtime.pinned,
            "nearby": self._runtime.nearby_flights,
