    ...
    return vol.Schema(
        {
            ...
            vol.Required(
                CONF_SHOW_SILHOUETTE,
                default=defaults.get(CONF_SHOW_SILHOUETTE, DEFAULT_SHOW_SILHOUETTE),
            ): bool,
            vol.Required(
                CONF_SHOW_PHOTO,
                default=defaults.get(CONF_SHOW_PHOTO, DEFAULT_SHOW_PHOTO),
            ): bool,
            vol.Required(
                CONF_AUTO_NIGHT,
                default=defaults.get(CONF_AUTO_NIGHT, DEFAULT_AUTO_NIGHT),
            ): bool,
            vol.Required(
                CONF_AIRLINERS_ONLY,
                default=defaults.get(CONF_AIRLINERS_ONLY, DEFAULT_AIRLINERS_ONLY),
            ): bool,
            vol.Required(
                CONF_HIDE_HELICOPTERS,
                default=defaults.get(CONF_HIDE_HELICOPTERS, DEFAULT_HIDE_HELICOPTERS),
            ): bool,
            vol.Required(
                CONF_HIDE_MILITARY,
                default=defaults.get(CONF_HIDE_MILITARY, DEFAULT_HIDE_MILITARY),
            ): bool,
            vol.Required(
                CONF_MIN_SPEED,
                default=defaults.get(CONF_MIN_SPEED, DEFAULT_MIN_SPEED),
            ): selector(
                {
                    "number": {
                        "min": 0,
...
def _store(
    ...
    data = {
        ...
        CONF_SHOW_SILHOUETTE: DEFAULT_SHOW_SILHOUETTE,
        CONF_SHOW_PHOTO: DEFAULT_SHOW_PHOTO,
        CONF_AUTO_NIGHT: DEFAULT_AUTO_NIGHT,
        CONF_AIRLINERS_ONLY: DEFAULT_AIRLINERS_ONLY,
        CONF_HIDE_HELICOPTERS: DEFAULT_HIDE_HELICOPTERS,
        CONF_HIDE_MILITARY: DEFAULT_HIDE_MILITARY,
        CONF_MIN_SPEED: DEFAULT_MIN_SPEED,
