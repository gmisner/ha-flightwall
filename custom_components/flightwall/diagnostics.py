...
async def async_get_config_entry_diagnostics(
    ...
    return {
        ...
        "inbound_delay": runtime.inbound_delay_seconds,
        "waiting_layout": runtime.waiting_layout,
        "show_radar": runtime.show_radar,
        "show_silhouette": runtime.show_silhouette,
        "show_photo": runtime.show_photo,
        "auto_night": runtime.auto_night,
        "pinned": runtime.pinned,
        "overhead_today": runtime.overhead_today,
